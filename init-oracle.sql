...
-- Cria o usuário SantaCasa se não existir
BEGIN
    EXECUTE IMMEDIATE 'CREATE USER SantaCasa IDENTIFIED BY SantaCasa123';
EXCEPTION
    WHEN OTHERS THEN
        IF SQLCODE = -1920 THEN
            NULL; -- Usuário já existe
        ELSE
            RAISE;
        END IF;
END;
...
-- Concede privilégios
GRANT CONNECT, RESOURCE, CREATE VIEW, CREATE SYNONYM TO SantaCasa;
GRANT UNLIMITED TABLESPACE TO SantaCasa;

-- Conecta como SantaCasa
CONNECT SantaCasa/SantaCasa123
